...
public class StatusTextScale3 {
    ...
    private static final int PLAYER_TEXT_OFFSET_X = 170;
    private static final int PLAYER_TEXT_OFFSET_Y = 4;
    private static final int MOUNT_TEXT_OFFSET_X  = 190;
    private static final int MOUNT_TEXT_OFFSET_Y  = 32;
    private static final int ARMOR_TEXT_OFFSET_X  = 150;
