...
public class HotbarScale1 {
    ...
    private static final float WIDGETS_SCALE_X = 455f / WIDGETS_WIDTH;
    private static final float WIDGETS_SCALE_Y = 55f / WIDGETS_HEIGHT;
    private static final float SLOT_SCALE_X = 32f / SELECT_SLOT_WIDTH;
    private static final float SLOT_SCALE_Y = 32f / SELECT_SLOT_HEIGHT;
    private static final float FRAME_SCALE_X = 67f / FRAME_WIDTH;
    private static final float FRAME_SCALE_Y = 67f / FRAME_HEIGHT;
    private static final float HEARTH_SCALE_X = 57f / HEARTH_WIDTH;
    private static final float HEARTH_SCALE_Y = 57f / HEARTH_HEIGHT;
    ...
    public static void render(DrawContext context) {
        ...
        renderItemName(context, client, centerX + 11, bottomY - 14, 67);

        StatusTextScale1.render(context, showPlayerHp, showMountHp, showArmor, showFood);

        int[] offsetX = {5, 5, 5, 5, 5, 5, 5, 5, 5};
        int[] offsetY = {4, 4, 4, 4, 4, 4, 4, 4, 4};
        ...
        BarsScale1.render(context, showWaterBar, LvLBar);
    ...
    private static void renderHeart(DrawContext context, int centerX, int bottomY, MinecraftClient client) {
        ...
        int frameX = centerX + 11;
        int frameY = bottomY - 14;
        int heartX = centerX + 16;
        int heartY = frameY + 5;
    ...
    private static int[] getSlotPositionsX(int centerX) {
        ...
        slotPositionsX[0] = centerX - 84 - 51;
        slotPositionsX[1] = centerX - 84 - 15;
        slotPositionsX[2] = centerX - 62;
        slotPositionsX[3] = centerX - 24;
        slotPositionsX[4] = centerX + 45 + 39;
        slotPositionsX[5] = centerX + 45 + 39 + 35;
        slotPositionsX[6] = centerX + 45 + 39 + 35 + 37;
        slotPositionsX[7] = centerX + 45 + 39 + 35 + 37 + 36;
        slotPositionsX[8] = centerX + 45 + 39 + 35 + 37 + 36 + 36;
